...
set PG_ENV_81="E:\Versionning\SVN\docpgfr\8.1\manuel"
set HHC="C:\Program Files\HTML Help Workshop\hhc.exe"

echo Suppression des fichiers temporaires précédents.

del /Q %PG_ENV_81%\chm\*.*
del %PG_ENV_81%\index.hhk
del %PG_ENV_81%\toc.hhc
del %PG_ENV_81%\htmlhelp.hhp

echo Génération des fichiers HTML

%DOCBOOK%\bin\xsltproc --xinclude %PG_ENV_81%\stylesheets\pg-chm.xsl %PG_ENV_81%\postgres.xml
...
copy /Y %PG_ENV_81%\stylesheets\pg-chm.css %PG_ENV_81%\chm\
